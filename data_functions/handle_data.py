...
# This function gives two options how to sort data.
# DEFAULT: pdga_numbers=False. This takes the players actual rating and round score
# OPTIONAL: pdga_numbers=True. This takes the rating already calculated by PDGA
import numpy as np
